...
void restart_root_service(int fd, void *cookie)
{
    ...
    char fusionsp_version[PROPERTY_VALUE_MAX];
    ...
    if (getuid() == 0) {
        ...
        property_get("ro.fusionsp.version", fusionsp_version, "");

        if (strlen(fusionsp_version) > 0 && strcmp(build_type, "eng") != 0 && (atoi(value) & 2) != 2) {
